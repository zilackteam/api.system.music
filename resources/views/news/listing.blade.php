...
@section('content')
    @if ($topNews)
        <section class="top-news">
            <a href="{{ route('news.detail', ['id' => $topNews->id]) }}" class="feature-img"><img src="{{ $topNews->feature_img }}" alt=""></a>
        ...
        <section class="list-news">
            @foreach($listNews as $news)
                <article class="single-news row">
                    <div class="col-xs-4">
                        <a href="{{ route('news.detail', ['id' => $news->id]) }}" class="feature-img"><img src="{{ $news->thumb_feature_img }}" alt=""></a>
                    </div>
                    <div class="col-xs-8">
